class BookManagementsController < ApplicationController
  ...
  private
    ...
    def book_management_params
      params.require(:book_management).permit(:student_id_143, :full_name_143, :class_143, :book_id_143, :book_name_143, :book_author_143, :book_category_143, :bm_number_143, :borrow_date_143, :back_date_143, :number_date_143)
    end
end
